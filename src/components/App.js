...
function App() {
  ...
  const [usdcTokenBalance, setUSDCTokenBalance] = useState("0");
  ...
  const loadBlockchainData = async () => {
    ...
    const usdcToken = new ethers.Contract(
      USDCToken.networks[networkId].address,
      USDCToken.abi,
      signer
    );
    ...
    const usdcTokenBalance = await usdcToken.balanceOf(account);
    setUSDCTokenBalance(usdcTokenBalance);
          ...
          <div className="row">
            <main
              ...
              <div className="content mx-auto">
                <Main
                  usdcTokenBalance={usdcTokenBalance}
