...
contract NFTFarm is Ownable, ERC1155Holder {
    ...
    USDCToken public token; // mock dai token being staked
    Crops public crops; // ERC-1155 NFT crops contract

    NFTInfo[] public nftInfo;
    mapping(address => UserInfo) public userInfo;

    constructor(uint256 _emissionRate, USDCToken _token, Crops _crops) {
